...
# Uses the environment variable if deployed, otherwise falls back to local MongoDB
MONGO_URI = os.getenv("MONGO_URI", "mongodb://localhost:27017/")
client = MongoClient(MONGO_URI)
db = client["adon_mevix"]
...
WHY_CHOOSE = [
    {
        "title": "Expert Team",
        "desc": "A passionate team of creatives and strategists dedicated to your success.",
        "icon": "team",
    },
    {
        "title": "Quality Work",
        "desc": "We deliver outstanding quality that speaks for your brand.",
        "icon": "quality",
    },
    {
        "title": "On-Time Delivery",
        "desc": "We value your time and ensure every project is delivered on schedule.",
        "icon": "clock",
    },
    {
        "title": "Results Driven",
        "desc": "Our strategies are focused on real results and business growth.",
        "icon": "results",
    },
]
...
PORTFOLIO = [
    {
        ...
        "desc": "Full brand identity refresh and social media launch for a premium craft brewery. Grew their Instagram from 0 to 18k in 90 days.",
        "stats": [
            {"label": "Followers gained", "value": "18K"},
            {"label": "Engagement rate", "value": "7.2%"},
            {"label": "Posts/month", "value": "23"},
        ],
        "color": "#7B2FF7",
    },
    {
    ...
    },
    {
        ...
        "desc": "Complete brand system for a luxury fashion label: logo, lookbook, catalogue, social templates and print collateral.",
        "stats": [
            {"label": "Catalogue pages", "value": "64"},
            {"label": "Print run", "value": "5,000"},
            {"label": "Retailers onboarded", "value": "28"},
        ],
        "color": "#F0B94D",
    },
    {
        ...
        "desc": "Product website, explainer video and motion-graphic onboarding flow for a B2B SaaS platform targeting SMEs.",
        "stats": [
            {"label": "Trial sign-ups", "value": "+210%"},
            {"label": "Bounce rate drop", "value": "−38%"},
            {"label": "Video views", "value": "92K"},
        ],
        "color": "#7B2FF7",
    },
    {
        ...
        "desc": "Monthly social management, food photography direction, targeted Meta ads and loyalty campaign for a chain of 4 cafés.",
        "stats": [
            {"label": "Footfall increase", "value": "+55%"},
            {"label": "Online orders", "value": "+3×"},
            {"label": "Reviews gained", "value": "800+"},
        ],
        "color": "#C9952C",
    },
]
...
TEAM = [
    {
        ...
        "bio": "10+ years crafting brand stories for startups and enterprises alike.",
        "initial": "AM",
    },
    {
        "name": "Priya Sharma",
        "role": "Head of Digital Strategy",
        "bio": "Data-driven strategist who turns audience insights into growth engines.",
        "initial": "PS",
    },
    {
        "name": "Rohan Das",
        "role": "Lead Web Developer",
        "bio": "Full-stack developer specialising in performance-first web experiences.",
        "initial": "RD",
    },
    {
        "name": "Sneha Kapoor",
        "role": "Social Media Manager",
        "bio": "Viral content architect with a knack for community building.",
        "initial": "SK",
    },
]
...
BLOG_POSTS = [
    {
        ...
        "body": [
            (
                "Short-form video is still king — but originality wins",
                "Reels and Shorts are saturated. The brands cutting through in 2025 are those leaning into unpolished, creator-style content. Authenticity is an algorithm signal.",
            ),
            (
                "AI content tools are table stakes, not an edge",
                "Every brand has access to AI copy generators now. What differentiates winners is curation and voice — knowing which output to use and how to layer in your brand's personality.",
            ),
            (
                "Micro-communities outperform broadcast channels",
                "Private groups and niche communities drive more qualified engagement than public feeds. Build a community around a shared interest, not just your product.",
            ),
            (
                "Social commerce is closing the funnel gap",
                "Instagram Checkout and TikTok Shop are turning discovery into purchase in a single session. If your product isn't shoppable on social, you're leaving conversions on the table.",
            ),
            (
                "LinkedIn is the underrated B2B growth channel",
                "Organic reach on LinkedIn is at an all-time high. Thought-leadership posts from founders consistently outperform company-page content.",
            ),
            (
                "Creator partnerships beat traditional influencers",
                "Nano and micro-creators with a tight niche deliver 3–5× the engagement rate of macro-influencers at a fraction of the cost.",
            ),
            (
                "Analytics are moving from vanity to revenue metrics",
                "Likes and follower counts are dead metrics. 2025 is about attributed revenue, cost-per-acquisition and lifetime value of community members.",
            ),
        ],
    },
    {
        ...
        "body": [
            (
                ...
                "Your Instagram uses one font, your website another, your packaging a third. Build a brand kit and enforce it across every channel.",
            ),
            (
                "Designing for yourself, not your audience",
                "Your brand colours should resonate with your ideal customer, not your personal taste. Mismatched aesthetics create instant cognitive dissonance.",
            ),
            (
                "Neglecting the verbal brand",
                "Your tone of voice is equally part of your brand identity. Define how you write captions, emails and CTAs — and stick to it.",
            ),
            (
                "Chasing trends instead of building timelessness",
                "Gradient logos are in this year and out the next. Aim for a visual identity that works for 5–10 years, then refresh incrementally.",
            ),
            (
                "No differentiation from category norms",
                "If your brand looks like every other brand in your category, you're invisible. Study competitors and deliberately stand apart in at least one dimension.",
            ),
        ],
    },
    {
        ...
        "body": [
            (
                ...
                "Visitors decide whether to stay within 3 seconds. Your headline must answer: what do you do, for whom, and why should I care — instantly.",
            ),
            (
                "Social proof above the fold",
                "A single powerful quote or recognisable client logo placed high on the page increases conversion by an average of 34%.",
            ),
            (
                "One primary CTA per page",
                "Multiple competing calls-to-action create decision paralysis. Every page should have one primary action you want visitors to take.",
            ),
            (
                "Page speed is a conversion lever",
                "A 1-second delay in page load reduces conversions by 7%. Compress images, use a CDN, and audit your Core Web Vitals monthly.",
            ),
            (
                "Mobile-first is non-negotiable",
                "Over 65% of web traffic in India is mobile. If your website is a desktop site that 'also works' on mobile, you're losing the majority of potential customers.",
            ),
            (
                "Build trust with transparency",
                "About pages, team photos and clear pricing dramatically reduce anxiety in potential customers. More information = lower perceived risk.",
            ),
        ],
    },
]
...
def services():
    return render_template(
        "services.html", services=SERVICES, why_choose=WHY_CHOOSE
    )
...
def pricing():
    return render_template(
        "pricing.html", plans=PLANS, website_packages=WEBSITE_PACKAGES
    )
...
def api_contact():
    ...
    try:
        submissions_collection.insert_one(entry)
    except Exception as e:
        return (
            jsonify(
                {"ok": False, "message": "Database error. Please try again."}
            ),
            500,
        )
    ...
    return jsonify(
        {
            "ok": True,
            "message": f"Thanks {name.split()[0]}, we've received your message. We'll reach out within 24 hours.",
        }
    )
